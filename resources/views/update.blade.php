        ...
        <div class="container mt-3 bg-light">
            <div class="row">
                <div class="col-xl-12 m-2">
                    <a href="/book" name="btnAdd" class="btn btn-info text-white">
                        back
                    </a>
        ...
        <div class="container mt-4 bg-light">
            <div class="row m-3">
                ...
                <div class="col-xl-6 mt-3">
                    ...
                    <input type="date" name="year" id="" class="form-control" value="{{$book->year}}">
                </div>
                <div class="col-xl-6 mt-3">
                    <label for="">Image</label>
                    <input type="file" name="image" id="photo" class="form-control" value="{{$book->image}}">
                </div>
                <div class="col-xl-6 mb-5"></div>
                <div class="col-xl-6 mb-5 mt-2">
                    <img id="preViewIMG" src="{{$book->image ? asset('images/' . $book->image) : 'https://t4.ftcdn.net/jpg/04/99/93/31/360_F_499933117_ZAUBfv3P1HEOsZDrnkbNCt4jc3AodArl.jpg'}}" height="200" alt="">
                </div>
            </div>
        </div>
    </form>
